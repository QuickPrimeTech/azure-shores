...
const socialLinks = [
  ...
  },
  {
    icon: Facebook,
    href: "#",
    label: "https://www.facebook.com/profile.php?id=61577138158760",
  },
    ...
    <div className="bg-white rounded-2xl shadow-lg p-8">
      ...
      <div className="bg-sand-beige-light rounded-lg p-6 mt-8">
        ...
        <p className="text-sm text-gray-600 mb-4">
          For immediate reservations, call us directly or use WhatsApp for quick
          responses.
        </p>
        <div className="flex gap-3">
          ...
          <Button
            ...
            asChild
          >
            <Link href={"wa.em/254717448835"}>WhatsApp</Link>
          </Button>
        </div>
      </div>
    </div>
